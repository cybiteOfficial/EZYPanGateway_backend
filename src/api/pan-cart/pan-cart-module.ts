...
import { PanCart, PanCartSchema } from "./entities/pan-cart.entity";
import { PanCartController } from "./pan-cart.controller";
...
export class PanCartModule implements NestModule {
