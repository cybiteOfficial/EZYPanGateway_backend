...
import { urlFields } from "./entities/gumasta-application.entity";
...
import { status } from "./entities/gumasta-application.entity";

export class GumastaHelper {
  constructor(
  ...
  async gumastaApplicationValidations(req) {
    try {
      const {
        propritorName,
        adhaarNumber,
