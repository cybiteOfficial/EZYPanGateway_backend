...
export class CategoryDsaConfig {
...
export type CategoryDsaConfigDocument = CategoryDsaConfig & Document;
export const CategoryDsaConfigSchema =
  SchemaFactory.createForClass(CategoryDsaConfig);
