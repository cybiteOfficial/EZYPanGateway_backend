...
export class DigitalPanApplicationFlow {
  @Prop()
...
export type DigitalPanFlowDocument = DigitalPanApplicationFlow & Document;
export const DigitalPanFlowSchema = SchemaFactory.createForClass(
