...
export enum urlFields {
  panCardFront = "Pan card front photo url",
  passportPhotoUrl = "Passport photo url",
  signaturePhotoUrl = "Signature photo url",
  panFormFrontPhotoUrl = "Pan form front photo url",
  panFormBackPhotoUrl = "Pan form back photo url",
  adhaarFrontPhotoUrl = "Adhaar front photo url",
  adhaarBackPhotoUrl = "Adhaar back photo url",
}

@Schema({ timestamps: true })
export class PanApplication {
...
export type PanDocument = PanApplication & Document;
export const PanAppSchema = SchemaFactory.createForClass(PanApplication);
