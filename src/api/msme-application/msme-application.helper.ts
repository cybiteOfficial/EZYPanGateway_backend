...
import { urlFields, status } from "./entities/msme-application.entity";
import {
  PriceConfig,
  PriceConfigDocument,
  serviceType,
...
export class MsmeHelper {
  ...
  async msmeApplicationValidations(req) {
    try {
      const {
        propritorName,
        firmName,
      ...
      const dataToSend = {
        ...
        status: "PAYMENT_PENDING", //status enum not working here
        ...req.body,
      };
